...
```bash
cd test_slow_on_connect_workbench
...
```bash
java -jar shinycannon-1.1.3-dd43f6b.jar recording.log https://staging.colorado.posit.co/rsc/content/837525f0-b7f7-4c6d-9cd1-77fdd4a2ebc0 --workers 3 --loaded-duration-minutes 2 --output-dir run3 --overwrite-output
```

```bash
java -jar shinycannon-1.1.3-dd43f6b.jar recording.log https://staging.colorado.posit.co/rsc/content/837525f0-b7f7-4c6d-9cd1-77fdd4a2ebc0 --workers 7 --loaded-duration-minutes 2 --output-dir run7 --overwrite-output
```
