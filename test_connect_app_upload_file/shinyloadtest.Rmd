...
# For some reason it's failing on main currently, websocket error
...
# Works on staging
shinyloadtest::record_session(
    target_app_url='https://colorado.posit.co/rsc/content/e297c186-e1a2-4afe-8abb-3edb52621559',
  connect_api_key=Sys.getenv("CONNECT_API_KEY"))
  # target_app_url='https://staging.colorado.posit.co/rsc/content/837525f0-b7f7-4c6d-9cd1-77fdd4a2ebc0',
  # connect_api_key=Sys.getenv("CONNECT_API_KEY_STAGING"))
```
...
Windows (using the URL as a variable): 
```bash
...
Windows (providing the URL directly): 

```bash
java -jar shinycannon-1.1.3-dd43f6b.jar recording.log https://staging.colorado.posit.co/rsc/content/837525f0-b7f7-4c6d-9cd1-77fdd4a2ebc0 --workers 1 --loaded-duration-minutes 2 --output-dir run1 --overwrite-output
```
...
target_url <- "https://staging.colorado.posit.co/rsc/content/837525f0-b7f7-4c6d-9cd1-77fdd4a2ebc0"
workers <- 1
dir <- "run1"
system(
  sprintf(
